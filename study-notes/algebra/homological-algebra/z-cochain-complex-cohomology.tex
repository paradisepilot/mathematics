...
& {\color{white}.}H^{1}(\mathcal{A}){\color{white}.} \arrow[r,"\widehat{\beta}_{1}"] \arrow[d, phantom, ""{coordinate, name=Z}]
& {\color{white}.}H^{1}(\mathcal{A}){\color{white}.}
\arrow[dll,
rounded corners,
to path={
	-- ([xshift=2ex]\tikztostart.east)
...
& {\color{white}.}H^{2}(\mathcal{A}){\color{white}.} \arrow[r,"\widehat{\beta}_{2}"] \arrow[d, phantom, ""{coordinate, name=Z}]
& {\color{white}.}H^{2}(\mathcal{A}){\color{white}.}
\arrow[dll,
rounded corners,
to path={
	-- ([xshift=2ex]\tikztostart.east)

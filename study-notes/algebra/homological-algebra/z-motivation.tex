...
\vskip 0.1cm
\noindent
Suppose $R$ is a ring with identity, and the following is an exact sequence of $R$-modules
...
\vskip 0.50cm
\noindent
\underline{Exactness of \eqref{inducedExactSequence} at $\Hom_{R}(M,D)$,\, i.e. $\image(\varphi^{\prime}) = \ker(\psi^{\prime})$}
\vskip 0.25cm
\noindent

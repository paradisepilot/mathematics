...
\chead[]{{\Large\bf Commutative Algebra} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{tex/Hom-and-localization}

%\clearpage
%\input{tex/cochain-complex-cohomology}

%\vskip 1.0cm
%\input{z-fibre-bundles}

%\vskip 1.0cm
%\input{z-principal-fibre-bundles}

%\vskip 1.0cm
%\input{z-reducible-structure-group}

%\clearpage
%\input{z-vertical-tangent-subbundle}

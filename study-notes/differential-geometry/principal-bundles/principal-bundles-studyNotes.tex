...
\chead[]{{\Large\bf Principal Fibre Bundles} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{tex/z-fibre-bundles}

\vskip 1.0cm
\input{tex/z-principal-fibre-bundles}

\vskip 1.0cm
\input{tex/z-reducible-structure-group}

\clearpage
\input{tex/z-vertical-tangent-subbundle}

...
\chead[]{{\Large\bf Derivation of the Einstein Field Equations} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{tex/Poisson-equation-of-Newtonian-mechanics}
\input{tex/energy-momentum-vector-of-a-particle}
\input{tex/energy-momentum-tensor}

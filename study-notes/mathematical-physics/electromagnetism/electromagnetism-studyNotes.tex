...
\chead[]{{\Large\bf Electromagnetism} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{z-Maxwells-equations-vector-calculus}

\vskip 0.5cm
\input{z-Maxwells-equations-differential-forms}

\vskip 0.5cm
\input{z-Maxwells-equations-gauge-theory-gauge-field}

\vskip 0.5cm
\input{z-gauge-transformations-quantum-mechanics}

...
The theory of homological algebra can be applied to the category of $R$-modules,
...
More precisely, we would need to work in a category with sufficient structure
...
Abelian categories precisely are the categories in which one apply homological algebra.
...
\vskip 0.5cm
\begin{definition}[Kernels and cokernels of morphisms in an additive category]
\mbox{}
\vskip 0.15cm
\noindent

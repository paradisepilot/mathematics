...
\item
	...
	&&{\color{blue}K(\pi_{K^{\prime\prime}})}
		...
		\arrow[dd, blue, double, "\alpha", swap]
	&&
	...
	A^{\prime}
		...
		\arrow[rr, blue, two heads, "{\color{white}...}\overset{{\color{white}.}}{\widetilde{\mu_{A}}}", swap]
		\arrow[rrrr, thick, bend left = 30, "\quad{\color{white}....}\mu_{A}"]
	&&
	{\color{blue}I(\mu_{A})\,\cong\,K(\varepsilon_{A})}
		\arrow[rr, blue, hook, "\kappa(\varepsilon_{A})", swap]
	...
	\item
		...
		& = &
			...
			\quad\textnormal{by Lemma 8.3.11(a)(i), p.180, \cite{kashiwara2005categories}}
		\\
		& = &
	...
	It remains to establish exactness.

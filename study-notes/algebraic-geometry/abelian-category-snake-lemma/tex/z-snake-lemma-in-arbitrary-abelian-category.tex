...
\item
	...
	{\color{red}A \,\sqcap_{A^{\prime\prime}}\! K^{\prime\prime}}
		\arrow[dd, red, thick, hook, "\,\pi_{A}", swap]
		\arrow[rr, red, thick, two heads, "\pi_{K^{\prime\prime}}"]
		\arrow[ddddll, thick, dashed, red, bend right = 20, "\theta", swap]
	&&
	K^{\prime\prime}
		\arrow[dd, hook, "\kappa^{\prime\prime}"]
	\\ \\
	A^{\prime}
		\arrow[dd, swap, "f^{\prime}"]
		\arrow[rr, "\mu_{A}"]
	...
	B^{\prime}
		\arrow[rr, thick, hook, swap, "\mu_{B}"]
		\arrow[dd, two heads, "\pi^{\prime}", swap]
	&&
	B
		\arrow[rr, "\varepsilon_{B}", swap]
		\arrow[dd, red, thick, two heads, "\iota_{B}"]
	&&
	B^{\prime\prime}
		% \arrow[dd, "\pi^{\prime\prime}"]
	\\ \\
	Q^{\prime}
		\arrow[rr, red, thick, hook, "\iota_{Q^{\prime}}", swap]
	&&
	{\color{red}Q^{\prime} \sqcup_{B^{\prime}}\! B}
		\arrow[rr, red, thick, two heads, "\pi(\iota_{Q^{\prime}}){\color{white}..}", swap]
	&&
	Q(\iota_{Q^{\prime}})
	\end{tikzcd}
	\end{center}
	...
	\,$\theta \in \Mor_{\mathfrak{A}}(\,A\,\sqcap_{A^{\prime\prime}} K^{\prime\prime}\,,\,B^{\prime}\,)$\,
	such that
	\,$f \,\circ\, \pi_{A} \,=\, \mu_{B} \,\circ\, \theta$.\,
	% \,$\delta \in \Mor_{\mathfrak{A}}(\,K^{\prime\prime}\,,\,Q^{\prime}\,)$\,
	% such that
	...
	\noindent
	\textbf{Claim 2:}\quad
	$(\,\pi^{\prime} \,\circ\, \theta\,) \,\circ\, \kappa(\pi_{K^{\prime\prime}}) \; = \; 0$
	\vskip 0.01cm
	\noindent
	Proof of Claim 2:\;\;
	...
	\,$\delta \in \Mor_{\mathfrak{A}}(\,K^{\prime\prime}\,,\,Q^{\prime}\,)$\,
	such that
	\,$\pi^{\prime} \,\circ\, \theta \;=\; \delta \,\circ\, \pi_{K^{\prime\prime}}$\,
	\vskip 0.01cm
	\noindent
	Proof of Claim 3:\;\;
	Recall that \,$\pi_{K^{\prime\prime}}$\, is a cokernel of its kernel
	\,$\kappa(\pi_{K^{\prime\prime}})$ [proof?].\,
	\begin{center}
	\begin{tikzcd}
	...
	K(\pi_{K^{\prime\prime}}) 
		...
		& &
		{\color{red}A\,\sqcap_{A^{\prime\prime}}\! K^{\prime\prime}}
		\arrow[rd, blue, thick, "\pi^{\prime}\,\circ\,\theta", swap]

...
\item
	...
	{\color{blue}A \,\sqcap_{A^{\prime\prime}}\! K^{\prime\prime}}
		\arrow[dd, blue, thick, hook, "\,\pi_{A}", swap]
		\arrow[rr, blue, thick, two heads, "\pi_{K^{\prime\prime}}"]
		\arrow[ddddll, blue, thick, dashed, bend right = 5, "\theta_{1}", swap]
	&&
	K^{\prime\prime}
	...
	\\ \\
	A^{\prime}
		\arrow[ddrr, "f^{\prime}", swap]
		\arrow[rr, two heads, "{\color{white}...}\overset{{\color{white}.}}{\widetilde{\mu_{A}}}", swap]
		\arrow[rrrr, bend left = 20, "\mu_{A}"]
	&&
	I(\mu_{A})\,\cong\,K(\varepsilon_{A})
		\arrow[rr, hook, "\kappa(\varepsilon_{A})", swap]
		\arrow[dd, blue, thick, dashed, "\theta_{2}", swap]
	&&
	A
		\arrow[dd, "f"]
		\arrow[rr, thick, two heads, "\varepsilon_{A}"]
	...
	Now, note that we furthermore have:

...
%	\end{center}
	...
	\vskip 0.3cm
	\textbf{Claim 1:} \;\,$f_{3} \circ \kappa_{P} \,=\, 0$.\,
	\vskip 0.01cm
	Proof of Claim 1:\;
	Consider the following augmented diagram, with the object \,$I_{\mu_{A}}$\, added:
	\begin{center}
	\vskip -1.5cm
	\begin{tikzcd}
	&&
	...
	K_{P}
		\arrow[d, "\kappa_{P}"]
		\arrow[dddddll, dashed, bend right = 30, swap, "f_{1}^{\prime}", red]		
	&
	\\
	&&
	&
	...
	P
		...
		\arrow[dddl, "f_{1}", blue]
		\arrow[dddddlll, bend right = 35, swap, "f_{2}", blue]
		\arrow[dddddddlll, bend right = 110, "f_{3}", blue]
	&
	\\
	&&
	K^{\prime}
	...
	K^{\prime\prime}
		\arrow[dd, "\kappa^{\prime\prime}"]
		\arrow[ddddddllll, thick, dashed, bend left = 29, "\textnormal{\Large$\delta$}", blue]
	\\ \\
	{\color{red}K_{0}}
	...
	A^{\prime}
		\arrow[dd, swap, "f^{\prime}"]
		\arrow[rr, "\mu_{A}"]
		\arrow[dr, two heads, "\widetilde{\mu_{A}}", red]
	&&
	A
		\arrow[dd, "f"]
		\arrow[rr, thick, two heads, "\varepsilon_{A}"]
	...
	&
	{\color{red}I_{\mu_{A}}}
		\arrow[ur, hook, swap, "\!\!\iota(\mu_{A}){\color{white}}", red]		
		\arrow[dl, dashed, "f_{2}^{\prime}", red]		
	&&&
	\\
	&&
	B^{\prime}
	...
	{\color{white}?????????????????????}
	\end{center}
	Here, by definition, the monomorphism

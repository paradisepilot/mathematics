...
%	\end{center}
	...
	\,$\theta$\, and \,$\theta_{1}$\, in their respective diagrams.
	Indeed, comparing the two immediately preceding diagrams, and noting the uniqueness of
	\,$\theta$\, and \,$\theta_{1}$\, in their respective diagrams,
	we see that we in fact must have \,$\theta = \theta_{1}$.\,
	Since \,$\theta_{1} \,=\, \theta$\, is an isomorphism
	(since \,$\theta$\, is an isomorphism, by the exactness hypothesis on
	\,$A^{\prime} \overset{\mu_{A}}{\longrightarrow} A \overset{\varepsilon_{A}}{\longrightarrow} A^{\prime\prime}$).

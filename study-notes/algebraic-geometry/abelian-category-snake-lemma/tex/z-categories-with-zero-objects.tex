...
and the universal property of \,$\gamma$\, as an equalizer of \,$f$\, and \,$g$.
...
\item
	...
	\end{tikzcd}
	\end{center}
	First, \,$\widetilde{f}$\, is an epimorphism, by Lemma \ref{fTildeIsEpimorphism} and
	the hypothesis that \,{\color{red}$\mathfrak{C}$\, has equalizers}.

...
\item
	We have established that $\widetilde{f}$ is an epimorphism.
	Here, we have assumed the additional hypothesis that $\mathfrak{C}$ is a conormal category.
	Hence, $\widetilde{f}$ is a cokernel of some morphism $g$.
	
	So, it remains only to prove that $g$ is a kernel of $f$.
\end{enumerate}
\qed

...
\chead[]{{\Large\bf Abelian Categories, the Snake Lemma \& Homological Algebra} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\vskip 1.0cm
\input{tex/z-categories-with-zero-objects}

\vskip 1.0cm
\input{tex/z-fiber-products-fiber-coproducts}

\vskip 1.0cm
\input{tex/z-additive-categories}

\vskip 1.0cm
\input{tex/z-abelian-categories}

% \vskip 1.0cm
% \input{tex/z-snake-lemma}

\vskip 1.0cm
\input{tex/z-snake-lemma-in-arbitrary-abelian-category}

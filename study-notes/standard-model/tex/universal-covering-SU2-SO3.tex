...
\chapter{The universal covering \,$\SU(2) \longrightarrow \SO(3)$\, and
the irreducible representations of \,$\su(2) \cong \so(3)$}
...
\item
	...
	Consequently, we may regard the codomain of the adjoint representation of \,$\SU(2)$\, to be \,$\SO(3)$,\,
	in other words,
	\begin{equation*}

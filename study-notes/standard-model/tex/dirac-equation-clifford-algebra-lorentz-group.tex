...
\vskip 0.5cm
\section{The Stone theorem and the Schr\"odinger equation}

\begin{itemize}
\item
	\underline{\textbf{The{\color{white}p}Stone Theorem}}
\item
	\underline{\textbf{``Derivation'' of the Schr\"odinger equation}}
	\vskip 0.1cm
	\noindent
	...
	\Psi(t,\mathbf{x})
	\;\; = \;\;
		e^{-\,\i\cdot\omega t} \cdot \psi(\mathbf{x})
	\end{equation*}
\end{itemize}
...
\vskip 0.1cm
\noindent
Suppose \,$A$\, is a self-adjoint operator on a complex Hilbert space \,$\mathbb{H}$\,
...
For each \,$t \in \Re$,\, define \,$\psi(t) \,:=\, e^{\i t A}\cdot\psi(0)$.\,
Then, \,$\psi(\cdot)$\, satisfies the Schr\"odinger equation, i.e., 

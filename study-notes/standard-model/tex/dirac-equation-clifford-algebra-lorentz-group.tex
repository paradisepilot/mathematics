...
is the phase space of the classical particle;
...
\vskip 0.5cm
\begin{proposition}[Momentum operator via Fourier transform]
\mbox{}
\vskip 0.05cm
\noindent
...
\left\langle\;
	\psi
	\,,\,
	\left(-\,\i\,\dfrac{\d}{\d x}\right)^{m}\!(\psi)
	\;\right\rangle
\;\; = \;\;
	\int_{\Re}\;\,

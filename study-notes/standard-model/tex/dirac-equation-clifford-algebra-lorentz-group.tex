...
\item
	...
	\,{\color{red}$X_{p} \,=\, \dfrac{\partial}{\partial x}$}\,
...
\begin{itemize}
\item
	Special-relativistic Energy-Momentum Relation for a {\color{red}free} particle
	(see \S3.4, \cite{DeFariaDeMelo2010}):
	\begin{equation}
...
\vskip 0.5cm
\section{The Clifford algebra \,$\textnormal{Cl}(1,3)$\,}

\begin{itemize}
\item
    $\left\{\,\gamma^{\mu}\,,\,\gamma^{\nu}\,\right\} \;=\;2\cdot g^{\mu\nu}$,\,
    where \,$g^{\mu\nu} = \diag(1,-1,-1,-1)$,\,
    is the defining condition for the Clifford algebra \,$\textnormal{Cl}(1,3)$.\,
    So, we know that \,$\gamma^{\mu}$\, must correspond to a representation of
    the Clifford algebra \,$\textnormal{Cl}(1,3)$,\,
    if we impose that \,$\psi$\, must satisfy both the Dirac equation and the Klein-Gordon equation. 
\item
    The complexification
    \,$\textnormal{Cl}(1,3)\otimes_{\,\Re}\C$\,
    of \,$\textnormal{Cl}(1,3)$\,
    is isomorphic to \,$\C\textnormal{l}(4)$,\, i.e.,
    \,$\textnormal{Cl}(1,3)\otimes_{\,\Re}\C \,\cong\, \C\textnormal{l}(4)$;\,
    see Lemma 6.3.2, p.335, \cite{Hamilton2017}.
\item
	In turn, the complex Clifford algebra
	% \,$\textnormal{Cl}(1,3)_{\C} \,\cong\, \C\textnormal{l}(4)$\,
	\,$\C\textnormal{l}(4)$\,
	is isomorphic to the full matrix algebra \,$M_{4}(\C)$\, of \,$4 \times 4$\, matrices
	with entries in \,$\C$,\, i.e.,
	% \,$\textnormal{Cl}(1,3)_{\C} \,\cong\, \C\textnormal{l}(4) \,\cong\, M_{4}(\C)$;\,
	\,$\C\textnormal{l}(4) \,\cong\, M_{4}(\C)$;\,
	see Theorem 6.3.21 and Table 6.1, p.345, \cite{Hamilton2017}.
\item
    For each \,$n \in \N$,\,
    the standard representation
    \,$M_{n}(\C) \longrightarrow \End(\C^{n})$\,
    is (up to isomorphism) the unique irreducible representation of
    the matrix algebra \,$M_{n}(\C)$.\,
    \vskip 0.1cm
    When the representation
    \,$\C\textnormal{l}(n) \cong M_{n}(\C) \longrightarrow \End(\C^{n})$\,
    is considered a representation of the complex Clifford algebra
    \,$\C\textnormal{l}(n)$,\, it is called the
    \textbf{(Dirac) spinor representation of the complex Clifford algebra \,$\C\textnormal{l}(n)$}.\,
    See Definition 6.4.1, p.346, \cite{Hamilton2017}.
\item
    The Lorentz spin group \,$\Spin(1,3)$\,
    is contained in the even subalgebra \,$\textnormal{Cl}^{0}(1,3)$\,
    of the Clifford algebra \,$\textnormal{Cl}(1,3)$.\,
    See Definition 6.2.14, p.332, \cite{Hamilton2017}, and
    Proposition 6.5.4, p.350, \cite{Hamilton2017}.
\item
    The representation of
    % \,$\Spin(1,3) \,\cong\, \SL(2,\C)$\,
    \,$\C\textnormal{l}^{0}(4)$\,
    induced by restriction
    from the standard representation (which is also the unique irreducible representation) of 
    \,$\C\textnormal{l}(4) \,\cong\, M_{4}(\C)$\,
    is NOT irreducible, but it decomposes into the direct sum of two inequivalent irreducible summands,
    which are called the \textbf{left-handed} and \textbf{right-handed Weyl spinor representations of
    \,$\C\textnormal{l}^{0}(4)$}.\,
    See Corollary 6.4.4, p.347, \cite{Hamilton2017}, and Proposition 6.4.5, p.348, \cite{Hamilton2017}.
\end{itemize}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\vskip 0.5cm
\section{The mass and spin of a Dirac field}

Recall:
\begin{itemize}
\item
    Each species of elementary particles is mathematically described by
    an irreducible representation of the Poincaré group.
\item
    The irreducible representations of the Poincaré group
    are classified by the eigenvalues of its two Casimir operators:
    \begin{equation*}
    P_{\mu}P^{\mu}\cdot\psi \,=\, m^{2}\,\psi\,
    \quad\quad\textnormal{and}\quad\quad
    W_{\mu}W^{\mu}\cdot\psi \,=\, -m^{2}\,s\,(s+1)\,\psi\,,
    \end{equation*}
    where \,$m^{2} \in \Re$\, is the mass, and
    \,$s \in \left\{\,0,\,\frac{1}{2},\,1,\,\frac{3}{2},\,2,\,\frac{5}{2},\ldots\,\right\}$\,
    is the spin of the given species of elementary particles.
\item
    In this section, we seek to show that a Dirac field \,$\psi$\, necessarily has spin $\frac{1}{2}$.
    Given the above facts, what we need to show is that,
    if a field \,$\psi$\, satisfies the Dirac equation (with mass parameter \,$m$,\, say),
    then it also satisfies the Klein-Gordon equation with the same mass parameter \,$m$,\,
    and it is an eigenvector of the square of the Pauli-Lubanski pseudovector with eigvenvalue 
    \,$-\,\dfrac{3}{4} \cdot m^{2} = -\,m^{2}\cdot\dfrac{1}{2}\cdot\left(\dfrac{1}{2}+1\right)$,\, i.e.,
    \begin{equation*}
    \left(\,\i\cdot\gamma^{\mu}\partial_{\mu} \overset{{\color{white}.}}{-} m\,\right)\cdot\psi \,=\, 0
    \quad\Longrightarrow\;\;
    \left\{\;\begin{array}{l}
        P_{\mu}P^{\mu}\cdot\psi \,=\, m^{2}\,\psi\,, \;\;\textnormal{and}
        \\
        W_{\mu}W^{\mu}\cdot\psi \,=\, -\,\dfrac{3}{4}\,m^{2}\,\psi\,,
        \end{array}\right.
    \end{equation*}
\end{itemize}
...
\left\{\;\begin{array}{l}
    ...
    \end{array}\right.
\end{equation*}
Consequently, {\color{red}every Dirac field \,$\psi$\, has spin \,$\dfrac{1}{2}$}.
\end{proposition}
\proof
For the first desired conclusion (\,i.e., \,$P_{\mu}P^{\mu}\cdot\psi = m^{2}\psi$\,),
recall that the Dirac equation was first conceived by Dirac as
a form of ``square root'' of the Klein-Gordon equation;
in particular, so that solutions of the Dirac equation
would also satisfy the Klein-Gordon equation.
Here is the formal proof:
\begin{eqnarray*}
\i\,\gamma^{\mu}\,\partial_{\mu}\left(\,\i\,\gamma^{\nu}\,\partial_{\nu}\,\psi\,\right)
& = &
    \i\,\gamma^{\mu}\,\partial_{\mu}\left(\,m\,\psi\,\right)
\;\; = \;\;
    m\cdot\left(\,\i\,\gamma^{\mu}\,\partial_{\mu}\psi\,\right)
\;\; = \;\;
    m\cdot\left(\,m\,\psi\,\right)
\;\; = \;\;
    m^{2}\,\psi
\\
\Vert\quad\quad\quad\,{\color{white}.}
&&
\\
% \i\,\gamma^{\mu}\,\partial_{\mu}\left(\,\i\,\gamma^{\nu}\,\partial_{\nu}\,\psi\,\right)
% & = &
    -\,\gamma^{\mu}\gamma^{\nu}\,\partial_{\mu}\partial_{\nu}\,\psi
& = &
    -\,\dfrac{\{\gamma^{\mu},\gamma^{\nu}\}}{2}\;\partial_{\mu}\partial_{\nu}\,\psi
\;\; = \;\;
    -\,\dfrac{2\,g^{\mu\nu}}{2}\;\partial_{\mu}\partial_{\nu}\,\psi
\;\; = \;\;
    -\,\partial^{\mu}\partial_{\nu}\,\psi
\;\; = \;\;
    -\,\textnormal{\large$\Box$}\,\psi\,,
\end{eqnarray*}
which implies: \,$\left(\,\textnormal{\large$\Box$} \,+\, m^{2}\,\right)\psi \,=\, 0$,\,
i.e., that \,$\psi$\, indeed satisfies the Klein-Gordon equation, as desired.

\vskip 0.1cm
\noindent
For the second desired conclusion (\,i.e., $W_{\mu}W^{\mu}\cdot\psi = -\,\dfrac{3}{4}\,m^{2}\,\psi$\,),
we follow the solution of Problem 4.10, p.98, \cite{Radovanovic2008}.
We start by recalling:
\,$W_{\mu} \,:=\, \dfrac{1}{2}\,\varepsilon_{\mu\nu\rho\sigma}\,M^{\nu\rho}P^{\sigma}$\,
and
\,$M^{\nu\rho} \,=\, \i\left(x^{\nu}P^{\rho} - x^{\rho}P^{\nu}\right) \,+\, \dfrac{1}{2}\,S^{\nu\rho}$.\,
Hence,
\begin{equation*}
W_{\mu}
\;\; = \;\;
    \dfrac{1}{4}\,\varepsilon_{\mu\nu\rho\sigma}\,S^{\nu\rho}P^{\sigma}
\;\; = \;\;
    \dfrac{\i}{4}\,\varepsilon_{\mu\nu\rho\sigma}\,S^{\nu\rho}\partial^{\sigma},
\end{equation*}
where the second equality follows from the fact that,
in the representation of the Poircaré group on the space of Dirac fields,
\,$P^{\sigma}$\, acts as \,$\i\,\partial^{\sigma}$.\,
...
& = &
    ...
    \!
    \left(\,
        \dfrac{\i}{4}\,\varepsilon^{\mu\alpha\beta\gamma}\,S_{\alpha\beta}\partial_{\gamma}
        \,\right)
    \psi
\;\; = \;\;
    -\,\dfrac{1}{16}\,
    \varepsilon_{\mu\nu\rho\sigma}\,\varepsilon^{\mu\alpha\beta\gamma}
    \cdot
    S^{\nu\rho}\,S_{\alpha\beta}
    \cdot
    \partial^{\sigma}\partial_{\gamma}\,\psi
\\
& = &
    {\color{red}+}\,\dfrac{1}{16}\,
    \left(\,
        {\color{red}\delta_{\nu}^{\alpha}\,\delta_{\rho}^{\beta}\,\delta_{\sigma}^{\gamma}}
        \,\overset{{\color{white}.}}{-}\,
        \delta_{\nu}^{\alpha}\,\delta_{\rho}^{\gamma}\,\delta_{\sigma}^{\beta}
        \,\overset{{\color{white}.}}{+}\,
        \delta_{\nu}^{\beta}\,\delta_{\rho}^{\gamma}\,\delta_{\sigma}^{\alpha}
        \,\overset{{\color{white}.}}{-}\,
        {\color{red}\delta_{\nu}^{\beta}\,\delta_{\rho}^{\alpha}\,\delta_{\sigma}^{\gamma}}
        \,\overset{{\color{white}.}}{+}\,
        \delta_{\nu}^{\gamma}\,\delta_{\rho}^{\alpha}\,\delta_{\sigma}^{\beta}
        \,\overset{{\color{white}.}}{-}\,
        \delta_{\nu}^{\gamma}\,\delta_{\rho}^{\beta}\,\delta_{\sigma}^{\alpha}
        \,\right)
    S^{\nu\rho}\,S_{\alpha\beta}
    \cdot
    \partial^{\sigma}\partial_{\gamma}\,\psi
...
& = &
    ...
    \left(\,
        \begin{array}{c}
            {\color{red}S^{\alpha\beta}S_{\alpha\beta}\cdot\partial^{\gamma}\partial_{\gamma}}
            \,-\,
            {\color{red}S^{\beta\alpha}S_{\alpha\beta}\cdot\partial^{\gamma}\partial_{\gamma}}
            \\
            \overset{{\color{white}1}}{-}\,
            S^{\alpha\gamma}S_{\alpha\beta}\cdot\partial^{\beta}\partial_{\gamma}
            \overset{{\color{white}1}}{+}\,
            S^{\beta\gamma}S_{\alpha\beta}\cdot\partial^{\alpha}\partial_{\gamma}
            \overset{{\color{white}1}}{+}\,
            S^{\gamma\alpha}S_{\alpha\beta}\cdot\partial^{\beta}\partial_{\gamma}
            \overset{{\color{white}1}}{-}\,
            S^{\gamma\beta}S_{\alpha\beta}\cdot\partial^{\alpha}\partial_{\gamma}
            \end{array}
        \,\right)
    \psi
\\
& = &
    ...
    \left(\,
        \begin{array}{c}
            {\color{black}S^{\alpha\beta}S_{\alpha\beta}\cdot\textnormal{\large$\Box$}}
            \;\;{\color{red}+}\;\,
            S^{{\color{red}\alpha\beta}}S_{\alpha\beta}\cdot\textnormal{\large$\Box$}
            \\
            \overset{{\color{white}1}}{-}\,
            S^{\alpha\gamma}S_{\alpha\beta}\cdot\partial^{\beta}\partial_{\gamma}
            \;\overset{{\color{white}1}}{{\color{red}-}}\;\,
            S^{{\color{red}\gamma\beta}}S_{\alpha\beta}\cdot\partial^{\alpha}\partial_{\gamma}
            \;\overset{{\color{white}1}}{{\color{red}-}}\;
            S^{{\color{red}\alpha\gamma}}S_{\alpha\beta}\cdot\partial^{\beta}\partial_{\gamma}
            \,\overset{{\color{white}1}}{-}\,
            S^{\gamma\beta}S_{\alpha\beta}\cdot\partial^{\alpha}\partial_{\gamma}
            \end{array}
        \,\right)
...
& = &
    ...
    \left(\,
        \begin{array}{c}
            2\cdot S^{\alpha\beta}S_{\alpha\beta}\cdot\textnormal{\large$\Box$}
            \\
            \overset{{\color{white}1}}{-}\,
            2 \cdot S^{\alpha\gamma}S_{\alpha\beta}\cdot\partial^{\beta}\partial_{\gamma}
            \,\overset{{\color{white}1}}{-}\,
            2 \cdot S^{\gamma\beta}S_{\alpha\beta}\cdot\partial^{\alpha}\partial_{\gamma}
            \end{array}
        \,\right)
    \psi
\\
& = &
    ...
    \left(\,
        \begin{array}{c}
            2\cdot\left(\,
                2\cdot\gamma_{\alpha}\gamma^{\alpha} + \delta^{\alpha}_{\alpha}
                \,\right)
            \cdot
            \textnormal{\large$\Box$}
            \\
            \overset{{\color{white}1}}{-}\,
            2 \cdot\left(\,
                2\cdot\gamma^{\gamma}\gamma_{\beta} + \delta^{\gamma}_{\beta}
                \,\right)
            \cdot\partial^{\beta}\partial_{\gamma}
            \,\overset{{\color{white}1}}{-}\,
            2 \cdot\left(\,
                2\cdot\gamma^{\gamma}\gamma_{\alpha} + \delta^{\gamma}_{\alpha}
                \,\right)
            \cdot\partial^{\alpha}\partial_{\gamma}
            \end{array}
        \,\right)
    \psi
\\
...
\;\; = \;\;
    ...
    \left(\,
        \begin{array}{c}
            ...
            \overset{{\color{white}1}}{-}\,
            4 \cdot\left(\,
                2\cdot\gamma^{\gamma}\gamma_{\beta}\cdot\partial^{\beta}\partial_{\gamma}
                +
                \textnormal{\large$\Box$}
                \,\right)
            \end{array}
...
& = &
    ...
    \left(\,
        \begin{array}{c}
            24 \cdot \textnormal{\large$\Box$}\,\psi
            \\
            \overset{{\color{white}1}}{-}\,
            4 \cdot\left(\,
                2\cdot\gamma_{\beta}\partial^{\beta}\left(\gamma^{\gamma}\partial_{\gamma}\psi\right)
                \overset{{\color{white}.}}{+}
                \textnormal{\large$\Box$}\,\psi
                \,\right)
            \end{array}
...
\;\; = \;\;
    ...
    \left(\,
        \begin{array}{c}
            24 \cdot \left(-\,m^{2}\,\psi\right)
            \\
            \overset{{\color{white}1}}{-}\,
            4 \cdot\left(\,
                2\cdot\gamma_{\beta}\,\partial^{\beta}\left(-\i\,m\,\psi\right)
                \overset{{\color{white}.}}{+}
                \left(-\,m^{2}\,\psi\right)
                \,\right)
            \end{array}
...
& = &
    ...
    \left(\,
        \begin{array}{c}
            ...
            \overset{{\color{white}1}}{-}\,
            4 \cdot\left(\,
                2\cdot(-m^{2}\,\psi)%\gamma_{\beta}\,\partial^{\beta}\left(-\i\,m\,\psi\right)
                \overset{{\color{white}.}}{+}
                \left(-\,m^{2}\,\psi\right)
                \,\right)
            \end{array}
...
\;\; = \;\;
    +\,\dfrac{1}{16}\,
    \left(\,
        -\,24 \,\overset{{\color{white}.}}{-}\, 4 \cdot (-3)
        \,\right)
    \cdot
    m^{2}\,\psi
\\
...
\\
& = &
    {\color{red}-}\,\dfrac{3}{4}\,m^{2}\,\psi\,,
\end{eqnarray*}
Since \,$W_{\mu}W^{\mu}\cdot\psi \,=\, -\,\,m^{2}\,s(s+1)\,\psi$,\,
it follows that \,$s(s+1) \,=\, \dfrac{3}{4}$.\,
Now observe:
\begin{equation*}
s(s+1) \,=\, \dfrac{3}{4}
...
s^{2} + s - \dfrac{3}{4} \,=\, 0
\quad\Longleftrightarrow\quad
\left(\,s - \dfrac{1}{2}\,\right)\!\left(\,s + \dfrac{3}{2}\,\right) \,=\, 0
\quad\Longrightarrow\quad
s \,=\, \dfrac{1}{2} \;,\; -\,\dfrac{3}{2} 
\end{equation*}
Since the spin of a species of elementary particles must be a non-negative multiple of \,$\dfrac{1}{2}$,\,
we see that we must have \,$s \,=\, \dfrac{1}{2}$\,
(\,i.e., we reject \,$s = -\,\dfrac{3}{2}$\, as inadmissible\,),\, as required.
\qed
          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

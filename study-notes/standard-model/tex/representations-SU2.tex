...
\vskip 0.5cm
\begin{proposition}[Set-theoretic characterizations of \,$\mathfrak{sl}(n,\C)$, \,$\mathfrak{u}(n)$, and $\mathfrak{su}(n)$]
\mbox{}
\vskip 0.1cm
\begin{enumerate}
\item
...
\vskip 0.5cm
\begin{proposition}[Some useful generators of \,$\mathfrak{su}(2)$]
...
\vskip 0.1cm
\noindent
Every irreducible finite-dimensional complex representation \,$\rho$\, of the complex Lie algebra
\,$\su(2) \otimes_{\Re} \C$\,
is equivalent to one of the representations explicitly constructed in Proposition \ref{IrrepsLittleSU2CXYd},
i.e., \,$\rho$\, is equivalent to
\begin{equation*}
\pi_{d} : \su(2) \otimes_{\Re} \C \,\longrightarrow\, \gl\!\left(\,\overset{{\color{white}.}}{\C}[X,Y]_{d}\,\right)
\end{equation*}

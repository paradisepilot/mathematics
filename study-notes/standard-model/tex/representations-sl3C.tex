...
\item
    Let
    \,$\mu : \mathfrak{h} \longrightarrow \C$\,
    be a weight for the Lie algebra representation\
    ...
    \,$\dim_{\C}(\,W_{\mu}\,)$.\,
\item
    A weight \,$\mu : \mathfrak{h} \longrightarrow \C$\, for the adjoint representation
    \,$\ad : \sl(3,\C) \longrightarrow \End\!\left(\,\overset{{\color{white}.}}{\sl(3,\C)}\,\right)$\,
    is called a \textbf{root} (or \textbf{root functional}) of the Lie algebra \,$\sl(3\,C)$.\,
    A \textbf{root vector} of the Lie algebra \,$\sl(3,\C)$\,

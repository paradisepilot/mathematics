...
\vskip 0.3cm
\noindent
Claim 1 and Proposition \ref{SDiagonalizableEqualsDirectSumOfWeightSpaces} together implies that
\,$\sl(3,\C)$\, can be expressed as a direct sum of (finitely many) {\color{red}weight} spaces.
Next, in order to determine these weight spaces, recall the following commutation relations:
\begin{equation*}
\begin{array}{ccr}
\left[H_{1},H_{2}\right] &=& 0,
\\ \\

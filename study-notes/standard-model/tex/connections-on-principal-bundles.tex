...
For \,$\xi \in \Omega^{k}(P,\mathfrak{g})$\, and \,$\eta \in \Omega^{l}(P,\mathfrak{g})$,\,
we define \,$\left[\,\xi\,,\,\eta\,\right] \,\in\, \Omega^{k+l}(P,\mathfrak{g})$\, as follows:
\begin{equation*}
\left[\,\xi\,,\,\eta\,\right](X_{1},\ldots,X_{k+l})
\;\; := \;\;
	\dfrac{1}{k! \cdot l!}\cdot
	\underset{\sigma\,\in\,S_{k+l}}{\sum}\,
	\textnormal{sign}(\sigma) \cdot
	\left[\;
		\overset{{\color{white}.}}{\xi}\!\left(X_{\sigma(1)}),\ldots,X_{\sigma(k)})\right)
		\,,\,
		\eta\!\left(X_{\sigma(k+1)}),\ldots,X_{\sigma(k+l)})\right)
		\;\right]_{\mathfrak{g}}
\end{equation*}
\end{definition}
...
\vskip 0.1cm
\noindent
In particular, if \,$\eta \in \Omega^{1}(P,\mathfrak{g})$,\, then
\begin{equation*}
{\color{red}
\left[\,\eta\,,\,\eta\,\right](X,Y)
\;\; = \;\;
	2 \cdot\! \left[\;
		\overset{{\color{white}.}}{\eta(X)}
		\,,\,
		\eta(Y)
		\;\right]_{\mathfrak{g}}
}\,,
...
& = &
	...
	\left[\;
		\overset{{\color{white}.}}{\eta(X_{(12)(1)})}
		\,,\,
		\eta(X_{(12)(2)})
		\;\right]_{\mathfrak{g}}
	\;+\;
	...
	\left[\;
		\overset{{\color{white}.}}{\eta(X_{(21)(1)})}
		\,,\,
		\eta(X_{(21)(2)})
		\;\right]_{\mathfrak{g}}
\\

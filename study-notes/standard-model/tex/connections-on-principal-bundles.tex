...
G
&
\xrightarrow{{\color{white}22.}\iota_{f(p)}^{-1}\,\circ\,f\,\circ\;\iota_{p}{\color{white}.22}}
&
G
\\
g
...
&
G
	\arrow[rrrr, thick, "\iota_{f(p \cdot h)}^{-1}\;\circ\;f\;\circ\;\iota_{p \cdot h}"]
	\arrow[dd, thick, "\Phi_{h}\;", swap]
&&&&
G
&
\!\!\!\!\!\!\!\! h^{-1} \cdot \sigma_{f}(p) \cdot g
\\ \\
g
	\arrow[rrrrrr, mapsto, bend right = 30]
&
G
	\arrow[rrrr, thick,"\iota_{f(p)}^{-1}\;\circ\;f\;\circ\;\iota_{p}", swap]
&&&&
G

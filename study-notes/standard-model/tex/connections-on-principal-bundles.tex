...
% \clearpage
% \section{The translates of a group by right multiplication}
...
% we can obtain a new group $G_{(h)}$ that is isomorphic to $G$ via right multiplication by $h$.
...
% \vskip 0.5cm
% \begin{lemma}[Each right translate of a group is itself a group]
% \mbox{}
% \vskip 0.05cm
% \noindent
...
% \\
% & (g_{1},g_{2}) & \xmapsto{{\color{white}22222}} & (g_{1} \cdot h^{-1}) \cdot (g_{2} \cdot h^{-1}) \cdot h \,=\, g_{1} \cdot h^{-1} \cdot g_{2}
% \end{array}
% \end{equation*}
% Then,
% \begin{enumerate}
...
% \item
% 	the map
% 	\,$\Phi_{h} : G \xrightarrow{{\color{white}222}} G_{(h)} \,:\, g \xmapsto{{\color{white}222}} g \cdot h $\,
...
% 	\;\; = \;\;
% 		\Phi_{h}\!\left[\,\left(\,\overset{{\color{white}.}}{g \cdot h^{-1}}\,\right)^{-1}\,\right]
% 	\;\; = \;\;
% 		\Phi_{h}\!\left[\,h \cdot g^{-1}\,\right]
% 	\;\; = \;\;
% 		h \cdot g^{-1} \cdot h
% 	\end{equation*}
% 	Indeed,
...
% 		\,\right)
% 	& = &
% 		g_{1} \cdot g_{2} \cdot h
% 	\;\; = \;\;
% 		\left(\,g_{1} \cdot h\,\right)
% 		\cdot h^{-1} \cdot
% 		\left(\,g_{2} \cdot h\,\right)
% 	\;\; = \;\;

...
\end{proposition}
\proof
We split the proof into three separate cases.
...
& = &
	\left(\,
		\overset{{\color{white}.}}{V^{\sharp}(\,\omega(W))}
		\,-\,
		W^{\sharp}(\,\omega(V))
		\,-\,
		\omega\!\left(\,[V^{\sharp},W^{\sharp}]\,\right)
...
\;\; \in \;\;
	\mathfrak{g}
\end{eqnarray*}
This proves the structure equation for the case where both $X$ and $Y$ are vertical.
...
\vskip 0.3cm
\noindent
\underline{$X${\color{white}p}is vertical and $Y$ is horizontal}
\vskip 0.1cm
\noindent
In this case, ...

...
\begin{itemize}
\item
	The states of a quantum system \,$\mathcal{S}$\,
	(e.g., a single particle, or an ensemble of particles, etc.)
	are unit vectors (alternative, one-dimensional subspaces)
	in a suitable (possibly infinite-dimensional) complex Hilbert space.
	This complex Hilbert space is call the \textbf{state space} of the quantum system.
	For the rest of this dicsussion, we will denote by \,$\mathbb{H}$\,
	the state space of the quantum system in question.
\item
	Two ``observers'' may ``coordinatize'' the state space \,$\mathbb{H}$\, differently.
	However, the coordinatizations of the state space \,$\mathbb{H}$\, by any two observers
	will be related by a complex linear transformation, i.e., by an element in
	\,$\U(\mathbb{H})$,\, where \,$\U(\mathbb{H})$\, denotes the group of unitary transformations
	defined on \,$\mathbb{H}$.\,
	\vskip -0.01cm
	\noindent
...
\item
	The quantum system \,$\mathcal{S}$\, is considered to ``possess'' or ``exhibit''
	...
	\vskip -0.01cm
	\noindent
	More precisely, the quantum system \,$\mathcal{S}$\, is considered to ``possess'' or ``exhibit''
	an \textbf{symmetry} if there exists a group \,$G$\, and a group homomorphism
	\,$\rho : G \xrightarrow{{\color{white}222}} \U(\mathbb{H})$\,
	such that
	\renewcommand{\labelitemii}{$\circ$}
	\begin{itemize}
	\item
		the group of empirically admissible transformations of \,$\mathcal{S}$\, is the image
		\,$\rho(G) \subset \U(\mathbb{H})$,\, and
	\item
		the image \,$\rho(G) \subsetneq \U(\mathbb{H})$\, is a proper subgroup of \,$\U(\mathbb{H})$.\,
	\end{itemize}
	Furthermore, the aforementioned ``symmetry'' of the quantum system \,$\mathcal{S}$\,
...
\item
	...
	of what are called ``fields'' in the physics literature.
	\vskip -0.01cm
	\noindent
	A quanum system is considered to possess an internal symmetry
	if its structure group is a proper subgroup of $\U(\mathbb{H})$.
	In this case, the structure group \,$G$\,
	of the corresponding complex vector bundle \,$E$\, admits a homomorphism
	\,$\rho : G \xrightarrow{{\color{white}222}} \U(\mathbb{H})$\,

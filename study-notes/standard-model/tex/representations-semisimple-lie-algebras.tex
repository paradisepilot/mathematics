...
The first key result we would like to establish is the following:
...
In order to prove the preceding Theorem, we will first establish a number of auxiliary results,
from which the proof of the Theorem will follow readily.

...
\item
	...
	\,$J^{2} \, := \, (J_{1})^{2} + (J_{2})^{2} + (J_{3})^{2} \,\in\, U(\mathfrak{so}(3) \otimes_{\Re} \C)$.
	Then,
	\begin{equation*}
	...
	\,$J^{2} \in U(\mathfrak{so}(3) \otimes_{\Re} \C)$\, acts as a scalar multiple of the identity in every irreducible
	...
	of \,$U(\mathfrak{so}(3) \otimes_{\Re} \C)$;\, more precisely, for each irreducible finite-dimensional
	complex representation
	\,$\rho : U(\mathfrak{so}(3) \otimes_{\Re} \C) \longrightarrow \mathfrak{gl}(V)$,\,
	we have \,$\rho(J^{2}) = \lambda \cdot \textnormal{\textbf{1}}_{V}$,\,
	for some \,$\lambda \in \C$.
\item
	\textbf{Raising and lowering operators:}\;\;
	Define \,$J_{+}\,,\, J_{-} \in \mathfrak{so}(3) \otimes_{\Re} \C \subset U(\mathfrak{so}(3) \otimes_{\Re} \C)$\, as follows:
	\begin{equation*}
	J_{\pm} \;\; := \;\; J_{1} \, \pm \sqrt{-1}\,J_{2}.
	\end{equation*}
	Then, the following equalities (of elements of $U(\mathfrak{so}(3) \otimes_{\Re} \C)$) hold:
	\begin{enumerate}
	\item

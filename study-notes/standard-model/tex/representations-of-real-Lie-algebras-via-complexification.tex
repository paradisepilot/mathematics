...
\chapter{Representations of real Lie algebras via those of their complexifications}
...
\section{The complexification of an arbitrary real Lie algebra}
\setcounter{theorem}{0}
\setcounter{equation}{0}
...
\section{A real Lie algebra and its complexification have the ``same'' irreducible finite-dimensional complex representations}
\setcounter{theorem}{0}
\setcounter{equation}{0}

...
\vskip 0.5cm
\begin{proposition}[Infinitesimal transformation law for Lorentz $4$-vectors]
\label{InfinitesimalLorentzFourVectorTransformationLaw}
\mbox{}
\vskip 0.1cm
\noindent
Suppose:
\,$Q_{0},\, Q_{1},\, Q_{2},\, Q_{3}$\,
are affine operators on \,$\Re^{1,3}$.\,
Then, the quantity
\,$\left(\,Q_{\mu}\,\right) \,:=\, \left(\,Q_{0},Q_{1},Q_{2},Q_{4}\,\right)$\,
transforms as a Lorentz $4$-vector if and only if
\,$Q_{\mu}$\, satisfies the following commutation relations:
\begin{equation*}
\left[\,M_{\mu\nu}
	\,\overset{{\color{white}1}}{,}\,
	Q_{\rho}
...
\vskip 0.1cm
\noindent
By Proposition \ref{InfinitesimalLorentzFourVectorTransformationLaw}, we see that
the transformation law in Proposition \ref{CommRelationsPM}(ii)
shows that \,$P_{\mu}$\, form a Lorentz four-vector (of affine operators on \,$\Re^{1,3}$).
Similarly, the transformation law in Proposition \ref{CommRelationsPauliLubanski}(ii)
shows that the Pauli-Lubanski vector \,$W_{\mu}$\,
(see Definition \ref{DefnPauliLubanskiFourVector} below)
indeed form a Lorentz four-vector (of affine operators on \,$\Re^{1,3}$).
\end{remark}

\vskip 0.3cm
\noindent
\proofof Proposition \ref{InfinitesimalLorentzFourVectorTransformationLaw}
\vskip 0.1cm
\noindent
That \,$\left(\,Q_{\mu}\,\right)$\, transforms as a Lorentz $4$-vector means the following:
\begin{equation*}
...
\end{equation*}
where
\,$U : \SOup(1,3) \longrightarrow \Isom(\Re^{1,3})$\,
is the canonical representation.
We will establish that the desired commutation relation
is an infinitesimal version of the above transformation law.
\begin{equation*}
\Lambda_{\mu}^{{\color{white}\mu}\nu}
\;\; = \;\;
	\delta_{\mu}^{\nu}
...
\label{DefnPauliLubanskiFourVector}
\mbox{}
\vskip 0.1cm
\noindent
...
\vskip 0.5cm
\begin{proposition}[Commutation relations of Pauli-Lubanski $4$-vector with $P_{\mu}$ and $M_{\mu\nu}$]
\label{CommRelationsPauliLubanski}
\mbox{}
\vskip 0.1cm
\noindent
...
\item
	...
	\; = \;
		\left(\,
			\varepsilon_{\rho\nu\beta\gamma}\,
			M_{\mu}^{{\color{white}\mu}\beta}P^{\gamma}
			+
			\dfrac{1}{2}\,\varepsilon_{\rho\nu\alpha\beta}\,
			M^{\alpha\beta}P_{\mu}
			\,\right)
		\;-\;
		\left(\,
			\varepsilon_{\rho\mu\beta\gamma}\,
			M_{\nu}^{{\color{white}\nu}\beta}P^{\gamma}
			+
			\dfrac{1}{2}\,\varepsilon_{\rho\mu\alpha\beta}\,
			M^{\alpha\beta}P_{\nu}
			\,\right)
	$
	\vskip 0.1cm
	...
	\;\; = \;\;
		\left[\,
			M_{\mu\nu}
			\,\overset{{\color{white}1}}{,}\,
			\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}\,M^{\alpha\beta}\,P^{\gamma}
			\,\right]
	\;\; = \;\;
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}
		\left[\,
			M_{\mu\nu}
			\,\overset{{\color{white}1}}{,}\,
			M^{\alpha\beta}\,P^{\gamma}
			\,\right]
	\\
	& = &
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}
		\left(\,
			M_{\mu\nu}\,M^{\alpha\beta}\,P^{\gamma}
			\,\overset{{\color{white}.}}{-}\,
			M^{\alpha\beta}\,P^{\gamma}\,M_{\mu\nu}
			\,\right)
	\\
	& = &
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}
	...
	& = &
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}
		\left(\,
			\left[\,M_{\mu\nu}\,,M^{\alpha\beta}\,\right] P^{\gamma}
			\,\overset{{\color{white}.}}{+}\,
			M^{\alpha\beta} \left[\,M_{\mu\nu}\,,P^{\gamma}\,\right]
			\,\right)
	\\
	& = &
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}
		\left(\,
			\left[\,M_{\mu\nu}\,,\eta^{\alpha\lambda}\,\eta^{\beta\sigma}\,M_{\lambda\sigma}\,\right] P^{\gamma}
			\,\overset{{\color{white}.}}{+}\,
			M^{\alpha\beta} \left[\,M_{\mu\nu}\,,\eta^{\gamma\lambda}\,P_{\lambda}\,\right]
			\,\right)
	\\
	& = &
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}
		\left(\,
			\eta^{\alpha\lambda}\,\eta^{\beta\sigma}
			\left[\,M_{\mu\nu}\,,M_{\lambda\sigma}\,\right] P^{\gamma}
			\;\overset{{\color{white}.}}{+}\;
			\eta^{\gamma\lambda}\,M^{\alpha\beta}
			\left[\,M_{\mu\nu}\,,P_{\lambda}\,\right]
			\,\right)
	\\
	& = &
		{\color{black}+}\;
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}\,\eta^{\alpha\lambda}\,\eta^{\beta\sigma}
		\left(\,
			%\left[\,M_{\mu\nu}\,,M_{\lambda\sigma}\,\right]
			\overset{{\color{white}.}}{-}\,
			\eta_{\lambda\mu}\,M_{\nu\sigma}
			+\,\eta_{\lambda\nu}\,M_{\mu\sigma}
			-\,\eta_{\sigma\mu}\,M_{\lambda\nu}
			+\,\eta_{\sigma\nu}\,M_{\lambda\mu}
			\,\right)
		P^{\gamma}
	\\
	&&
		+\;
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}\,\eta^{\gamma\lambda}\,M^{\alpha\beta}
		\left(\,
			%\left[\,M_{\mu\nu}\,,P_{\lambda}\,\right]
			\overset{{\color{white}.}}{-}\,
			\eta_{\lambda\mu}\,P_{\nu}
	...
	& = &
		...
		\left(\,
			%\left[\,M_{\mu\nu}\,,M_{\lambda\sigma}\,\right]
			\overset{{\color{white}.}}{-}\,
			\eta^{\alpha\lambda}\,\eta^{\beta\sigma}\,\eta_{\lambda\mu}\,M_{\nu\sigma}
			+\,\eta^{\alpha\lambda}\,\eta^{\beta\sigma}\,\eta_{\lambda\nu}\,M_{\mu\sigma}
			-\,\eta^{\alpha\lambda}\,\eta^{\beta\sigma}\,\eta_{\sigma\mu}\,M_{\lambda\nu}
			+\,\eta^{\alpha\lambda}\,\eta^{\beta\sigma}\,\eta_{\sigma\nu}\,M_{\lambda\mu}
			\,\right)
		P^{\gamma}
	\\
	&&
		+\;
		\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}\,M^{\alpha\beta}
		\left(\,
			%\left[\,M_{\mu\nu}\,,P_{\lambda}\,\right]
			\overset{{\color{white}.}}{-}\,
			\eta^{\gamma\lambda}\,\eta_{\lambda\mu}\,P_{\nu}
			\,+\,
			\eta^{\gamma\lambda}\,\eta_{\lambda\nu}\,P_{\mu}
			\,\right)
	\\
	& = &
		{\color{black}+}\;
		...
		\left(\,
			\overset{{\color{white}.}}{-}\,
			\delta^{\alpha}_{\mu}\,M_{\nu}^{{\color{white}\nu}\beta}
			+\,\delta^{\alpha}_{\nu}\,M_{\mu}^{{\color{white}\mu}\beta}
			-\,\delta^{\beta}_{\mu}\,M^{\alpha}_{{\color{white}\alpha}\nu}
			+\,\delta^{\beta}_{\nu}\,M^{\alpha}_{{\color{white}\alpha}\mu}
			\,\right)
		P^{\gamma}
	\\
	&&
	...
	& = &
		...
		\left(\,
			...
			\delta^{\alpha}_{\mu}\,M_{\nu}^{{\color{white}\nu}\beta}
			+\,\delta^{\alpha}_{\nu}\,M_{\mu}^{{\color{white}\mu}\beta}
			-\,({\color{red}-1})^{{\color{red}2}}\,\delta^{{\color{red}\alpha}}_{\mu}\,
				M^{{\color{white}\alpha}{\color{red}\beta}}_{{\color{red}\nu}}
			+\,({\color{red}-1})^{{\color{red}2}}\,\delta^{{\color{red}\alpha}}_{\nu}\,
				M^{{\color{white}\alpha}{\color{red}\beta}}_{{\color{red}\mu}}
			\,\right)
		P^{\gamma}
	\\
	&&
	...
	& = &
		{\color{black}+}\;
		\varepsilon_{\rho\alpha\beta\gamma}
		\left(\,
			\overset{{\color{white}.}}{-}\,
			\delta^{\alpha}_{\mu}\,M_{\nu}^{{\color{white}\nu}\beta}
			+\,\delta^{\alpha}_{\nu}\,M_{\mu}^{{\color{white}\mu}\beta}
	...
	& = &
		\left(\,
			\varepsilon_{\rho\alpha\beta\gamma}\,
			\delta^{\alpha}_{\nu}\,M_{\mu}^{{\color{white}\mu}\beta}P^{\gamma}
			\,+\,
			\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}\,
			M^{\alpha\beta}\,\delta^{\gamma}_{\nu}\,P_{\mu}
			\,\right)
		\,-\,
		\left(\,
			\varepsilon_{\rho\alpha\beta\gamma}\,
			...
			\,+\,
			\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\gamma}\,
			M^{\alpha\beta}\,\delta^{\gamma}_{\mu}\,P_{\nu}
			\,\right)
	\\
	& = &
		\left(\,
			...
			M_{\mu}^{{\color{white}\mu}\beta}P^{\gamma}
			\,+\,
			\dfrac{1}{2}\,\varepsilon_{\rho{\color{red}\nu}\alpha\beta}\,
			M^{\alpha\beta}P_{\mu}
			\,\right)
		\,-\,
		\left(\,
			...
			M_{\nu}^{{\color{white}\nu}\beta}P^{\gamma}
			\,+\,
			\dfrac{1}{2}\,\varepsilon_{\rho{\color{red}\mu}\alpha\beta}\,
			M^{\alpha\beta}P_{\nu}
			\,\right)
	\end{eqnarray*}
	This proves Claim 1.
	...
	M_{\mu}^{{\color{white}\mu}\beta}P^{\gamma}
	\,+\,
	\dfrac{1}{2}\,\varepsilon_{\rho\alpha\beta\nu}\,
	M^{\alpha\beta}P_{\mu}
	\;\; = \;\;
	    -\,\eta_{\rho\mu}\,W_{\nu} \,+\, \eta_{\nu\mu}\,W_{\rho}
	$
	...
	\noindent
	Proof of Claim 2:\;\;
	First, observe that the full anti-symmetrization of an arbitary rank-five tensor
	defined on $4$-dimensional space must vanish (since repeated indices must occur).
	Hence, we see that:
    \begin{equation*}
    \varepsilon_{[\rho\nu\beta\gamma}\,\eta_{\sigma]\mu}
    \;\; = \;\;
    	0
    \end{equation*}
    The full unsimplified expansion of the anti-symmetrized tensor
    on the left-hand side of the above equation has $5! = 120$ terms.
    However, due to the anti-symmetry of \,$\varepsilon_{\rho\mu\beta\gamma}$,\,
    these \,$5! = 120$\, terms collapse to
    \,$\left(\begin{array}{c} 5 \\ 4 \end{array}\right) = 5$\,
    distinct terms (number of ways to choose 4 among the five indices
    \,$\rho,\nu,\beta,\gamma,\eta,\sigma$\, to appear in the fully anti-symmetric Levi-Civita tensor
    \,$\varepsilon_{****}$).
    In particular, invoking the anti-symmetry of
    \,$\varepsilon_{\rho\nu\beta\gamma}$\,
    and collecting like terms, the preceding equation reduces to:
    \begin{equation*}
    24\cdot\!\left(\,
	    \varepsilon_{\rho\nu\beta\gamma}\,\eta_{\sigma\mu}
	    \,\overset{{\color{white}.}}{-}\,
	    \varepsilon_{\sigma\nu\beta\gamma}\,\eta_{\rho\mu}
	    \,+\,
	    \varepsilon_{\sigma\rho\beta\gamma}\,\eta_{\nu\mu}
	    \,-\,
	    \varepsilon_{\sigma\rho\nu\gamma}\,\eta_{\beta\mu}
	    \,+\,
	    \varepsilon_{\sigma\rho\nu\beta}\,\eta_{\gamma\mu}
	    \,\right)
    \;\; = \;\;
    	0
    \end{equation*}
    ...
    \;\; = \;\;
    	0
    \end{equation*}
    Multiplying the preceding equation through by
    \,$\dfrac{1}{2}\,M^{\nu\beta}P^{\gamma}$\,
    yields:
    \begin{eqnarray*}
    0
    & = &
	    {\color{white}\,+\,}
    	\dfrac{1}{2}\,\varepsilon_{\rho\nu\beta\gamma}\,\eta_{\sigma\mu}\,M^{\nu\beta}P^{\gamma}
	    \,\overset{{\color{white}.}}{-}\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\nu\beta\gamma}\,\eta_{\rho\mu}\,M^{\nu\beta}P^{\gamma}
    \\
    &&
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\beta\gamma}\,\eta_{\nu\mu}\,M^{\nu\beta}P^{\gamma}
	    \,-\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\nu\gamma}\,\eta_{\beta\mu}\,M^{\nu\beta}P^{\gamma}
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\nu\beta}\,\eta_{\gamma\mu}\,M^{\nu\beta}P^{\gamma}
	\\
    & = &
	    {\color{white}\,+\,}
	    \eta_{\sigma\mu}\left(\,
    ...
    &&
	    ...
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\beta\gamma}\,\eta_{\nu\mu}\,M^{\nu\beta}P^{\gamma}
	    \,-\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho{\color{red}\beta}\gamma}\,\eta_{{\color{red}\nu}\mu}\,
	    	M^{{\color{red}\beta\nu}}P^{\gamma}
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\nu\beta}\,\eta_{\gamma\mu}\,M^{\nu\beta}P^{\gamma}
	\\
    & \overset{{\color{white}\textnormal{\large$1$}}}{=} &
	    {\color{white}\,+\,}
	    \eta_{\sigma\mu}\,W_{\rho}
	    \,\overset{{\color{white}.}}{-}\,
	    \eta_{\rho\mu}\,W_{\sigma}
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\beta\gamma}\,\eta_{\nu\mu}
	    	\left(\,
	    		M^{\nu\beta}
	    		\,\overset{{\color{white}.}}{-}\,
	    		{\color{red}(-1)}\,M^{{\color{red}\nu\beta}}
	    		\,\right)
			P^{\gamma}
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\nu\beta}\,\eta_{\gamma\mu}\,M^{\nu\beta}P^{\gamma}
    ...
    & \overset{{\color{white}\textnormal{\large$1$}}}{=} &
	    ...
	    \varepsilon_{\sigma\rho\beta\gamma}\,\eta_{\nu\mu}\,M^{\nu\beta}P^{\gamma}
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho{\color{red}\alpha}\beta}\,
	    	\eta_{\gamma\mu}\,M^{{\color{red}\alpha}\beta}P^{\gamma}
	\\
    & \overset{{\color{white}\textnormal{\large$1$}}}{=} &
	    {\color{white}\,+\,}
	    \eta_{\sigma\mu}\,W_{\rho}
	    ...
	    \eta_{\rho\mu}\,W_{\sigma}
	    \,+\,
	    \varepsilon_{\sigma\rho\beta\gamma}\,M^{{\color{white}\mu}\beta}_{\mu}P^{\gamma}
	    \,+\,
	    \dfrac{1}{2}\,\varepsilon_{\sigma\rho\alpha\beta}\,M^{\alpha\beta}P_{\mu}
    \end{eqnarray*}
    Hence,
    \begin{equation*}
    \varepsilon_{\sigma\rho\beta\gamma}\,M^{{\color{white}\mu}\beta}_{\mu}P^{\gamma}
    ...
    \;\; = \;\;
	    ...
	    \eta_{\rho\mu}\,W_{\sigma}
    \end{equation*}
    Under the index renaming $\rho\rightarrow\nu$,\, $\sigma\rightarrow\rho$, we have:
    \begin{equation*}
    \varepsilon_{\rho\nu\beta\gamma}\,M^{{\color{white}\mu}\beta}_{\mu}P^{\gamma}
    \,+\,
    \dfrac{1}{2}\,\varepsilon_{\rho\nu\alpha\beta}\,M^{\alpha\beta}P_{\mu}
    \;\; = \;\;
	    -\,\eta_{\rho\mu}\,W_{\nu}
	    \,\overset{{\color{white}.}}{+}\,
	    \eta_{\nu\mu}\,W_{\rho}
...
\vskip 0.5cm
\begin{theorem}[Two Casimir elements of \,$\mathcal{U}(\so(1,3)\ltimes\Re^{1,3})$]
\mbox{}
\vskip 0.1cm
\noindent
...
\,$\so(1,3)\ltimes\Re^{1,3}$.\,
To this end, we first state and prove:

\vskip 0.3cm
\noindent
\textbf{Claim 1:}\quad
Let \,$Q_{0},\, Q_{1},\, Q_{2},\, Q_{3}$\, be affine operators on \,$\Re^{1,3}$.\,
Then,
\begin{equation*}
\left.\begin{array}{ccl}
	\left[\,P_{\alpha}\,\overset{{\color{white}1}}{,}\,Q_{\mu}\,\right]
	& = &
		0
	\\
	\left[\,M_{\alpha\beta}\,\overset{{\color{white}1}}{,}\,Q_{\mu}\,\right]
	& \overset{{\color{white}\textnormal{\large$1$}}}{=} &
		-\,\eta_{\mu\alpha}\,Q_{\beta} \,+\, \eta_{\mu\beta}\,Q_{\alpha} 
	\end{array}\right\}
\quad\Longrightarrow\quad
	\left\{\begin{array}{ccc}
		\left[\,P_{\alpha}\,\overset{{\color{white}1}}{,}\,Q_{\mu}\,Q^{\mu}\,\right]
		& = &
			0
		\\
		\left[\,M_{\alpha\beta}\,\overset{{\color{white}1}}{,}\,Q_{\mu}\,Q^{\mu}\,\right]
		& \overset{{\color{white}\textnormal{\large$1$}}}{=} &
			0
		\end{array}\right.
\end{equation*}
...
\left[\,
	...
	\,\right]
& = &
	M_{\alpha\beta}\,Q_{\mu}\,Q^{\mu}
	\,-\,
	Q_{\mu}\,Q^{\mu}\,M_{\alpha\beta}
% \\
% & \overset{{\color{white}\textnormal{\small$1$}}}{=} &
\;\; = \;\;
	M_{\alpha\beta}\,Q_{\mu}\,Q^{\mu}
...
& {\color{black}=} &
	\left(\,
		-\,\eta_{\mu\alpha}\,Q_{\beta}
		\,\overset{{\color{white}.}}{+}\,
		\eta_{\mu\beta}\,Q_{\alpha}
		\,\right)
	Q^{\mu}
	\;+\;
	\eta^{\mu\nu}\,Q_{\mu}
...
& = &
	...
	\;+\;
	\left(\,
		-\,\eta^{\mu\nu}\,\eta_{\nu\alpha}\,Q_{\mu}\,Q_{\beta}
		\,\overset{{\color{white}.}}{+}\,
		\eta^{\mu\nu}\,\eta_{\nu\beta}\,Q_{\mu}\,Q_{\alpha}
		\,\right)
\\
& = &
	\left(\,
	...
	\;+\;
	\left(\,
		-\,\delta^{\mu}_{\alpha}\,Q_{\mu}\,Q_{\beta}
		\,\overset{{\color{white}.}}{+}\,
		\delta^{\mu}_{\beta}\,Q_{\mu}\,Q_{\alpha}
		\,\right)
\\
& = &
	\left(\,
...
\vskip 0.3cm
\noindent
Now, by Proposition \ref{CommRelationsPM},
we see that \,$P_{\mu}$\, satisfies the the hypothesis of Claim 1.
Similarly, by Proposition \ref{CommRelationsPauliLubanski},
we see that \,$W_{\mu}$\, satisfies the hypothesis of Claim 1.
Consequently, the Theorem follows immediately from Claim 1.
This completes the proof of the Theorem.
\qed


\vskip 0.5cm
\begin{theorem}[Eigenvalues of $C_{2} = W_{\mu}W^{\mu}$ in relation to those of $C_{1} = P_{\mu}P^{\mu}$]
\mbox{}
\vskip 0.1cm
\noindent
Suppose that
\,$\rho : \SOup(1,3) \ltimes \Re^{1,3} \longrightarrow U(\mathcal{H})$\,
is an irreducible unitary representation of
\,$\SOup(1,3) \ltimes \Re^{1,3}$\,
on a complex Hilbert space
\,$\mathcal{H}$\,
(necessarily infinite-dimensional since $\SOup(1,3) \ltimes \Re^{1,3}$ is not compact), and
that the eigenvalue of
\,$\rho_{*}\!\left(P_{\mu}P^{\mu}\right) \in \End(\mathcal{H})$\, is \,$m^{2} \in \Re$.\,
Then, the following statements hold:
\begin{enumerate}
\item
	If \,$m^{2} > 0$,\, then the eigenvalue of
	\,$\rho_{*}\!\left(W_{\mu}W^{\mu}\right)$\,
	is \;{\color{red}$-\,m^{2} \cdot s \cdot (s+1)$},\; where
	\,$s \in \left\{\,0,\,\frac{1}{2},\,1,\,\frac{3}{2},\,2,\,\frac{5}{2},\,\ldots\,\right\}$\,
	such that \,$s \cdot (s+1)$\, is the eigenvalue of the Casimir element
	\begin{equation*}
	\rho_{*}\!\left(\,\mathbf{J}^{2}\,\right)
	\;\; = \;\;
		\rho_{*}\!\left(\,J_{1}^{2} + J_{2}^{2} + J_{3}^{2}\,\right)
	\;\; = \;\;
		\rho_{*}\!\left(\,M_{23}^{2} + M_{31}^{2} + M_{12}^{2}\,\right)
	\end{equation*}
	of \,$\so(3)$.\,
\item
	If \,$m^{2} = 0$,\, then the eigenvalue of
...
\begin{enumerate}
\item
	Since \,$W_{\mu}W^{\mu}$\, is a Casimir element of the Lie algebra of
	\,$\SOup(1,3) \ltimes \Re^{1,3}$,\,
	the operator
	\,$\rho_{*}(W_{\mu}W^{\mu}) \in \End(\mathcal{H})$\,
	is a scalar multiple of the identity map on \,$\mathcal{H}$,\,
	where that scalar is the eigenvalue of
	\,$\rho_{*}(W_{\mu}W^{\mu}) \in \End(\mathcal{H})$.\,
	In other words, there exists \,$\lambda \in \Re$\, such that
	\begin{equation*}
	\rho_{*}(W_{\mu}W^{\mu})\!\left[\,\mathbf{v}\,\right]
	\;\; = \;\;
		\lambda \cdot \mathbf{v}\,,
	\quad
	\textnormal{for each \,$\mathbf{v} \in \mathcal{H}$}
	\end{equation*}
	We need to show that
	\,$\lambda \,=\, -\,m^{2} \cdot s \cdot (s+1)$.\,
	\vskip 0.1cm
	Observe that we can compute \,$\lambda \in \Re$\, by evaluating
	\,$\rho_{*}(W_{\mu}W^{\mu}) \in \End(\mathcal{H})$\,
	at an arbitrary non-zero \,$\mathbf{v} \in \mathcal{H}$.\,
	\vskip 0.1cm
	Recall that the operators
	\,$P_{0}, P_{1}, P_{2}, P_{3}$\,
	pairwise commute;
	hence, they preserve the eigenvectors of each other:
	\begin{equation*}
	\left.\begin{array}{ccc}
		\left[\,P_{\mu}\,,\,P_{\nu}\,\right] & = & 0
		\\
		\overset{{\color{white}1}}{P_{\mu}(\mathbf{w})} &=& \lambda\cdot\mathbf{w}
		\end{array}
	\;\;\right\}\Longrightarrow\;\;
	P_{\mu}\!\left(\,P_{\nu}(\mathbf{w})\,\right)
	\,=\,
		P_{\nu}\!\left(\,P_{\mu}(\mathbf{w})\,\right)
	\,=\,
		P_{\nu}\!\left(\,\lambda\cdot\mathbf{w}\,\right)
	\,=\,
		\lambda \cdot P_{\nu}(\,\mathbf{w}\,)
	\end{equation*}
	Similarly,
	...
	\begin{equation*}
	\rho_{*}(P_{\mu}P^{\mu})\!\left[\,\mathbf{v}\,\right]
	\;\; = \;\;
		m^{2} \cdot \mathbf{v}\,,
	\quad
	\textnormal{for each \,$\mathbf{v} \in \mathcal{H}$}
	\end{equation*}
	\vskip 0.1cm
	Let \,$\mathbf{v} \in \mathcal{H}\,\backslash\,\{\,0\,\}$\, be a simultaneous eigenvector of
	\,$\rho_{*}(P_{0}),\; \rho_{*}(P_{1}),\; \rho_{*}(P_{2}),\; \rho_{*}(P_{3})$.\,
	Without loss of generality (by applying a suitable Lorentz transformation if necessary),
	we may assume that the eigenvalues of \,$\mathbf{v}$\, for
	\,$\rho_{*}(P_{0}),\; \rho_{*}(P_{1}),\; \rho_{*}(P_{2}),\; \rho_{*}(P_{3})$\,
	are $m$, $0$, $0$ and $0$, respectively.
	Note that, physically, this choice of inertial frame the rest frame the massive particle.
	\vskip 0.1cm
	Since the eigenvalue of \,$\rho_{*}(W_{\mu}W^{\mu})$\, is Poincaré-invariant,
	we can compute it in any convenient choice of inertial frame.
	If we use the rest frame of the massive particle, then the eigenvalues
	\,$(\,p_{0},p_{1},p_{2},p_{3}\,) \,=\, (\,m,\,0,\,0,\,0\,)$.\,
	Hence,
	\begin{equation*}
	W_{\mu}
	\;\; := \;\;
	...
	& = &
		\left(\,
			...
			\,\right)\!(\mathbf{v})
	\end{eqnarray*}
	Writing the temporal and spatial components separately, we have:
	\begin{eqnarray*}
	W_{0}
	& = &
		\dfrac{1}{2}\,\varepsilon_{{\color{red}0\,}\nu\rho{\color{red}\,0}}\,M^{\nu\rho}P^{0}
	\;\; = \;\;
		0
	\\
	W_{k}
	& = &
		\dfrac{1}{2}\,\varepsilon_{k\nu\rho 0}\,M^{\nu\rho}P^{0}
	\;\; = \;\;
		m\cdot{\color{red}\dfrac{1}{2}\,\varepsilon_{k\nu\rho}\,M^{\nu\rho}}
	\;\; = \;\;
		m\cdot{\color{red}J_{k}}
	\end{eqnarray*}
	\begin{eqnarray*}
	W_{0}(\mathbf{v})
	& = &
	...
	& = &
		\left(\,
			...
			\,\right)\!(\mathbf{v})
	\;\; = \;\;
		m\cdot\!\left(\,{\color{red}\dfrac{1}{2}\,\varepsilon_{k\nu\rho}\,M^{\nu\rho}}\,\right)\!(\mathbf{v})
	\;\; = \;\;
		m\cdot{\color{red}J_{k}}(\mathbf{v})
	\end{eqnarray*}
	Hence, in the rest frame of the massive particle, we have
	\begin{eqnarray*}
	W_{\mu}W^{\mu}
	& = &
		W_{0}W^{0}
		...
		\,-\, \left(\,m J_{3}\,\right)^{2}
	\;\; = \;\;
		0 \,-\, m^{2}\left(\,J_{1}^{2} + J_{2}^{2} + J_{3}^{2}\,\right)
	\\
	& = &
		-\,m^{2}\,s\,(s+1)\,
	\end{eqnarray*}
	...
	\,$s \in \left\{\,0,\,\frac{1}{2},\,1,\,\frac{3}{2},\,2,\,\frac{5}{2},\,\ldots\,\right\}$\,
	such that
	\,$s\,(s+1)$\, is the eigenvalue of the Casimir element

...
\vskip 0.5cm
\section{The Lie algebra of \,$\SL(2,\C) \ltimes \Re^{1,3}$}
...
\begin{enumerate}
\item
	$\left[\,r_{m}\,,r_{n}\,\right] \,=\, \varepsilon_{mnk}\,r_{k}$,\, for each \,$m,n,k = 1,2,3$
\item
	\vskip 0.3cm
	$\left[\,b_{m}\,,b_{n}\,\right] \,=\, -\,\varepsilon_{mnk}\,r_{k}$,\, for each \,$m,n,k = 1,2,3$
\item
	\vskip -0.23cm
	$\left[\,r_{m}\,,b_{n}\,\right] \,=\, +\,\varepsilon_{mnk}\,b_{k}$,\, for each \,$m,n,k = 1,2,3$
\item
	\vskip 0.3cm
...
\item
	\vskip -0.23cm
	$\left[\,r_{m}\,,t_{n}\,\right] \,=\, \varepsilon_{mnk}\,t_{k}$,\, for each \,$m,n,k = 1,2,3$
\item
	\vskip 0.3cm

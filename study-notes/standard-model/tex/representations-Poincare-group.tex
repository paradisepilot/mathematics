...
\item
	...
	\left[\,
		...
		\,\right]
	& = &
		P_{\lambda}\,W^{\mu} \,-\, W^{\mu}P_{\lambda}
	\;\; = \;\;
		P_{\lambda}
		\cdot\!
		\left(\,\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,M_{\nu\rho}\,P_{\sigma}\,\right)
		\,-\,
		\left(\,\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,M_{\nu\rho}\,P_{\sigma}\,\right)
		\!\cdot
		P_{\lambda}
	\\
	& = &
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,P_{\lambda}\left(\,M_{\nu\rho}\,P_{\sigma}\,\right)
		\;-\;
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,M_{\nu\rho}\left(\,P_{\sigma}\,P_{\lambda}\,\right)
	\\
	& = &
		...
		\left(\,
			...
			\,\right)
		\;-\;
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,M_{\nu\rho}\,P_{\sigma}\,P_{\lambda}
	\\
	& = &
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,P_{\lambda}\,P_{\sigma}\,M_{\nu\rho}
		\,-\,
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,\eta_{\sigma\nu}\,P_{\lambda}\,P_{\rho}
		\,+\,
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,\eta_{\sigma\rho}\,P_{\lambda}\,P_{\nu}
		\,-\,
		\dfrac{1}{2}\,\varepsilon^{\mu\nu\rho\sigma}\,M_{\nu\rho}\,P_{\sigma}\,P_{\lambda}
	% \\
	% & = &
	...
	& \overset{{\color{white}\textnormal{\large$1$}}}{=} &
		0\,,
		\quad
		\textnormal{due to the anti-symmetry of \,$\varepsilon^{\mu\nu\sigma\rho}$\,
		(in $\mu,\nu,\sigma,\rho$) and symmetry of \,$P_{\mu}\,P_{\nu}$\, (in $\mu,\nu$)}
	\end{eqnarray*}
\item
	We compute:
	\begin{eqnarray*}

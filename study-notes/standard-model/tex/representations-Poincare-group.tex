...
anti-symmetrically in \,$\mu$\, and \,$\nu$,\,
as follows:
\begin{itemize}
\item
	$M_{0m} \, := \, K_{m}$,\, for \,$m = 1,2,3$,
\item
	$M_{mn} \, := \, \varepsilon_{mnk} \, J_{k}$\, for \,$m, n = 1,2,3$,
\end{itemize}
...
% \item
% 	The above generators satisfy the following commutation relations:
% 	\begin{itemize}
% 	\item
% 		$\left[\,P_{\mu}\,,\,P_{\nu}\,\right] \,=\, 0$,\, for \,$\mu, \nu \in \{\,0,1,2,3\,\}$,
% 	\item
...
\item
	...
	\;\; = \;\;
		+1
	\end{eqnarray*}
	Next, note that, for \,$k \in \{\,1,2,3\,\}$,\, we have:
	\begin{eqnarray*}
	% \left(M_{01}\right)_{{\color{red}01}}
	% & = &
	% 	\eta_{{\color{red}0}0}\delta_{{\color{red}1}1}
	% 	\,-\,
	% 	\eta_{{\color{red}0}1}\delta_{{\color{red}1}0}
	% \;\; = \;\;
	% 	(\,+1\,)(+1) \,-\, 0 \cdot 0
	% \;\; = \;\;
	% 	+1
	% \\
	% \left(M_{01}\right)_{{\color{red}10}}
	% & = &
	% 	\eta_{{\color{red}1}0}\delta_{{\color{red}0}1}
	% 	\,-\,
	% 	\eta_{{\color{red}1}1}\delta_{{\color{red}0}0}
	% \;\; = \;\;
	% 	0 \cdot 0 \,-\, (\,-1\,)(+1)
	% \;\; = \;\;
	% 	+1
	% \\
	% \left(M_{02}\right)_{{\color{red}02}}
	% & \overset{{\color{white}\textnormal{\Large$1$}}}{=} &
	% 	\eta_{{\color{red}0}0}\delta_{{\color{red}2}2}
	% 	\,-\,
	% 	\eta_{{\color{red}0}2}\delta_{{\color{red}2}0}
	% \;\; = \;\;
	% 	(\,+1\,)(+1) \,-\, 0 \cdot 0
	% \;\; = \;\;
	% 	+1
	% \\
	% \left(M_{02}\right)_{{\color{red}20}}
	% & = &
	% 	\eta_{{\color{red}2}0}\delta_{{\color{red}0}2}
	% 	\,-\,
	% 	\eta_{{\color{red}2}2}\delta_{{\color{red}0}0}
	% \;\; = \;\;
	% 	0 \cdot 0 \,-\, (\,-1\,)(+1)
	% \;\; = \;\;
	% 	+1
...
\vskip 0.5cm
\begin{proposition}[Commutation relations of $M_{\mu\nu}$]
\mbox{}
\vskip 0.1cm
\noindent
The generators \;\;

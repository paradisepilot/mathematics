...
\vskip 0.5cm
\section{The probability distribution of the states of a canonical ensemble is a Boltzmann distribution}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

In this subsection, we establish that the probability distribution of the states
...
in thermal equilibrium with a heat reservoir at a fixed temperature.
\end{definition}
...
is in the accessible micro-state \,$\psi$.\,
Then, we have:
\begin{equation*}
P(\,\Psi = \psi\,)
\;\; = \;\;
...
\quad
\begin{array}{c}
\textnormal{for each accessible micro-state \,$\psi$}
\\
...
the {\color{red}thermodynamic definition of absolute temperature}
\;$
\dfrac{1}{T}
\, = \,
    \dfrac{

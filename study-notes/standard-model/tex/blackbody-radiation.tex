...
meaning its first derivative is zero ($\d S_{\textnormal{total}} = 0$):
\begin{equation*}
0
\;\; = \;\;
...
for any arbitrary energy fluctuation \,$\d E_{A}$\, implies that
the term in the parentheses must be exactly zero:
\begin{equation*}
\dfrac{\partial S_{A}}{\partial E_{A}}
\;\; = \;\;
    \dfrac{\partial S_{B}}{\partial E_{B}}
...
Under appropriate boundary conditions, we expect that the solution
describing the full electromagnetic field

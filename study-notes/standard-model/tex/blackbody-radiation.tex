...
For any two blackbody radiation cavities
\,$C_{1}, C_{2} \,\in\, \mathcal{C}$\,
...
& := &
    \left(\begin{array}{c}
        ...
        \\
        \textnormal{admissible modes of vibration}
        \\
        \textnormal{per unit volume, at frequency \,$\nu$}
        \end{array}\right),
    \quad
    \textnormal{and}
\\
...
\;\; = \;\;
    \int_{0}^{\infty} N(\nu) \langle\,E(\nu,T)\,\rangle \,\d\nu
\;\; = \;\;
    \int_{0}^{\infty} V \cdot g(\nu) \langle\,E(\nu,T)\,\rangle \,\d\nu
\end{equation*}

\begin{equation*}
\int_{0}^{\infty}\, g(\nu) \langle\,E(\nu,T)\,\rangle \,\d\nu
\;\; = \;\;
    \dfrac{U_{\textnormal{total}}}{V}
\;\; = \;\;
    \left(\begin{array}{c}
        \textnormal{energy}
        \\
...
\noindent
Proof of Claim 1:\;
Immediate by the following observation:
\begin{equation*}
\int_{0}^{\infty}\, \dfrac{\d N(\nu)}{\d\nu} \,\d\nu
\;\; = \;\;
    N(\nu)
\;\; = \;\;
    \int_{0}^{\infty}\, V \cdot g(\nu) \,\d\nu
...
\end{eqnarray*}
Now, recall the relation between the magnitude of the wave vector and the frequency:
\begin{equation*}
\vert\,\mathbf{k}\,\vert
\; = \;
    \dfrac{2\,\pi}{\lambda}
...
\vskip 0.4cm
\noindent
The Proposition now follows immediately from Claim 1 and Claim 3.
\qed
...
\item
    ...
    n\,h\,\nu \xmapsto{{\color{white}....}} \exp\!\left(\,\overset{{\color{white}.}}{-\,n\,h\,\nu\,/\,k_{B}\,T}\,\right)
    $.\,
\end{itemize}
\vskip 0.2cm
...
\item
    For each fixed frequency \,$\nu \in (\,0,\infty\,)$,\,
    the collection \,$\mathscr{E}_{\nu}$\, of admissible energies
    among all modes of vibration is given by:
    \begin{equation*}
    \mathscr{E}_{\nu}
    \;\; = \;\;
        \left[\,0,\infty\,\right)

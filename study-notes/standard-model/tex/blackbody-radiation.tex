...
\section{Universality of the energy density spectrum of black body radiation -- Kirchhoff's law of thermal radiation}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\vskip 0.5cm
\begin{theorem}[Universality of the energy density spectrum of black body radiation]
\mbox{}
\vskip 0.1cm
\noindent
Suppose:
\begin{itemize}
\item
    $\mathcal{C}$\, is the set of all possible black body radiation cavities.
    We remark that black body radiation cavities are
...
\item
    ...
    for the black body radiation cavity \,$C \in \mathcal{C}$.\,
\end{itemize}
Assume:
\begin{itemize}
\item
...
\item
    ...
    If two black body radiation cavities
...
For any two black body radiation cavities
\,$C_{1}, C_{2} \,\in\, \mathcal{C}$\,

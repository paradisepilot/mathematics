...
\chead[]{{\Large\bf Spectral Theory} \\
\vskip 0.1cm \normalsize \today}
\lfoot[]{}
\cfoot[]{}
\rfoot[]{\thepage}
...
\input{tex/spectrum-of-bounded-operators-on-Hilbert-spaces}

\clearpage
\input{tex/compact-operators-on-Hilbert-spaces}

\clearpage
\input{tex/compact-self-adjoint-operators-on-Hilbert-spaces}

          %%%%% ~~~~~~~~~~~~~~~~~~~~ %%%%%

\clearpage
\appendix
\input{tex/compact-linear-maps-between-normed-vector-spaces}
